# Преобразование таблицы child_mortality_urban_1990_2021.xls к истинным субъектам РФ -> CSV
import pandas as pd


if __name__ == '__main__':
    regions = pd.read_csv('data/normal_data/regions.csv',index_col=0)
    data = pd.read_excel('data/social_russia_data/child_mortality_urban_1990_2021.xls',header=2)
    ...
    regions.merge(data,how='left',left_on='Region',right_on='Region').to_csv('data/normal_data/child_mortality_urban_1990_2021.csv')    