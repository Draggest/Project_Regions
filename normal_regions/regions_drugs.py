# Объединение листов drugs из тамблицы drug_alco.xlsx, преобразование к истинным субъектам -> CSV 
import pandas as pd

if __name__ == '__main__':
    regions = pd.read_csv('data/normal_data/regions.csv',index_col=0)
    data = pd.read_excel('data/social_russia_data/drug_alco.xlsx',sheet_name='drugs')
    data2 = pd.read_excel('data/social_russia_data/drug_alco.xlsx',sheet_name='drug1718')
    ...
    test_data.merge(data2,how='left',left_on='Region',right_on='Region').to_csv('data/normal_data/drugs_2005_2018.csv')